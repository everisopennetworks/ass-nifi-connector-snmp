package com.everis.nttdata.snmp.models;
...
public class Event implements Serializable {
    ...
    /**
     * Nombre descriptivo del tipo de la alarma según el OSS
     * */
    @JsonInclude(JsonInclude.Include.NON_NULL)
    ...
    /**
     * Marca de tiempo que indica cuándo se generó la alarma en el origen.
     * */
    // --------@JsonInclude(JsonInclude.Include.NON_NULL)
  ...
  /*  private long alarmOSSCreatedTime;
    ...
    /**
     *Identificador del tipo de evento para manejar el ciclo de vida de la alarma.
     * */
    @JsonInclude(JsonInclude.Include.NON_NULL)
    ...
    /**
     * Identificador del tipo de alarma según el OSS
     * */
    @JsonInclude(JsonInclude.Include.NON_NULL)
...
// TEST    @JsonInclude(JsonInclude.Include.NON_NULL)
    ...
    public Event(){}
    /*Se Manejan los Set's and Get's para cada una de las variables*/
